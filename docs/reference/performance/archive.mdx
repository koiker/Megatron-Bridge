...
NOTE: This page contains performance summaries for past releases. You can find the summary for the latest release at [performance-summary.md](/reference/performance/summary).
