...
[the hierarchical CP skill](https://github.com/NVIDIA-NeMo/Megatron-Bridge/blob/main/skills/nemo-mbridge-perf-hierarchical-context-parallel/SKILL.md).
...
- [docs/training/communication-overlap.mdx](/training/communication-overlap)
- [Hierarchical CP skill](https://github.com/NVIDIA-NeMo/Megatron-Bridge/blob/main/skills/nemo-mbridge-perf-hierarchical-context-parallel/SKILL.md)
- [Hierarchical CP skill card](https://github.com/NVIDIA-NeMo/Megatron-Bridge/blob/main/skills/nemo-mbridge-perf-hierarchical-context-parallel/card.yaml)
