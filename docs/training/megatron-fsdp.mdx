...
verification commands, see [skills/nemo-mbridge-perf-megatron-fsdp/SKILL.md](https://github.com/NVIDIA-NeMo/Megatron-Bridge/blob/main/skills/nemo-mbridge-perf-megatron-fsdp/SKILL.md).
...
- [docs/training/cpu-offloading.mdx](/training/cpu-offloading)
- [docs/training/performance-tuning.mdx](/training/performance-tuning)
- [skills/nemo-mbridge-perf-megatron-fsdp/SKILL.md](https://github.com/NVIDIA-NeMo/Megatron-Bridge/blob/main/skills/nemo-mbridge-perf-megatron-fsdp/SKILL.md)
- [skills/nemo-mbridge-perf-megatron-fsdp/card.yaml](https://github.com/NVIDIA-NeMo/Megatron-Bridge/blob/main/skills/nemo-mbridge-perf-megatron-fsdp/card.yaml)
