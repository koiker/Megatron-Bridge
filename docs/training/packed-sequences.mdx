...
and verification commands, see [skills/nemo-mbridge-perf-sequence-packing/SKILL.md](https://github.com/NVIDIA-NeMo/Megatron-Bridge/blob/main/skills/nemo-mbridge-perf-sequence-packing/SKILL.md).
...
- `docs/training/performance-tuning.mdx`
...
- [docs/training/multi-token-prediction.mdx](/training/multi-token-prediction)
...
- [skills/nemo-mbridge-perf-sequence-packing/SKILL.md](https://github.com/NVIDIA-NeMo/Megatron-Bridge/blob/main/skills/nemo-mbridge-perf-sequence-packing/SKILL.md)
- [skills/nemo-mbridge-perf-sequence-packing/card.yaml](https://github.com/NVIDIA-NeMo/Megatron-Bridge/blob/main/skills/nemo-mbridge-perf-sequence-packing/card.yaml)
