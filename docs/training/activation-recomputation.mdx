...
- [docs/training/moe-optimization.mdx](/training/moe-optimization)
- [skills/nemo-mbridge-perf-activation-recompute/SKILL.md](https://github.com/NVIDIA-NeMo/Megatron-Bridge/blob/main/skills/nemo-mbridge-perf-activation-recompute/SKILL.md) — per-module cost/savings data, measured results
- [skills/nemo-mbridge-perf-memory-tuning/SKILL.md](https://github.com/NVIDIA-NeMo/Megatron-Bridge/blob/main/skills/nemo-mbridge-perf-memory-tuning/SKILL.md) — expandable segments, parallelism resizing, and other memory reduction strategies
