...
[skills/nemo-mbridge-perf-cpu-offloading/SKILL.md](https://github.com/NVIDIA-NeMo/Megatron-Bridge/blob/main/skills/nemo-mbridge-perf-cpu-offloading/SKILL.md).
...
- [docs/training/activation-recomputation.mdx](/training/activation-recomputation)
- [docs/training/megatron-fsdp.mdx](/training/megatron-fsdp)
- [docs/training/optimizer-scheduler.mdx](/training/optimizer-scheduler)
