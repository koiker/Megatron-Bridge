...
[parallelism strategies skill](https://github.com/NVIDIA-NeMo/Megatron-Bridge/blob/main/skills/nemo-mbridge-perf-parallelism-strategies/SKILL.md).
...
- **Operational skill**: [skills/nemo-mbridge-perf-parallelism-strategies/SKILL.md](https://github.com/NVIDIA-NeMo/Megatron-Bridge/blob/main/skills/nemo-mbridge-perf-parallelism-strategies/SKILL.md) — enablement, pitfalls, memory estimation, verification
- **Knowledge card**: [skills/nemo-mbridge-perf-parallelism-strategies/card.yaml](https://github.com/NVIDIA-NeMo/Megatron-Bridge/blob/main/skills/nemo-mbridge-perf-parallelism-strategies/card.yaml) — structured metadata and validation status
