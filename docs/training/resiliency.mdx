...
parameter tables, code anchors, and verification commands, see [skills/nemo-mbridge-resiliency/SKILL.md](https://github.com/NVIDIA-NeMo/Megatron-Bridge/blob/main/skills/nemo-mbridge-resiliency/SKILL.md).
...
- Requires compatible checkpoint format (see [skills/nemo-mbridge-resiliency/SKILL.md](https://github.com/NVIDIA-NeMo/Megatron-Bridge/blob/main/skills/nemo-mbridge-resiliency/SKILL.md))
...
- [docs/training/checkpointing.mdx](/training/checkpointing)
- [docs/training/performance-tuning.mdx](/training/performance-tuning)
- [skills/nemo-mbridge-resiliency/SKILL.md](https://github.com/NVIDIA-NeMo/Megatron-Bridge/blob/main/skills/nemo-mbridge-resiliency/SKILL.md)
- [skills/nemo-mbridge-resiliency/card.yaml](https://github.com/NVIDIA-NeMo/Megatron-Bridge/blob/main/skills/nemo-mbridge-resiliency/card.yaml)
- [NVIDIA Resiliency Extension](https://github.com/NVIDIA/nvidia-resiliency-ext)
