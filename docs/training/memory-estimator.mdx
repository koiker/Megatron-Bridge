---
title: "Theoretical Memory Estimator"
description: ""
---
...
with the runtime guidance in [CPU Offloading](/training/cpu-offloading),
[Activation Recomputation](/training/activation-recomputation), and
[Megatron FSDP](/training/megatron-fsdp).
