...
### Nemotron H
- Nemotron H recipes: [bridge.recipes.nemotronh](/reference/api)

### Nemotron Nano v2
- Nemotron Nano v2 recipes: [bridge.recipes.nemotronh.nemotron_nano_v2](/reference/api)
...
- Recipe usage and customization: [Recipe usage](/training/recipe-usage)
