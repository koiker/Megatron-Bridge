...
> See [Cherrypick Policy](/resources/contributing/cherrypick-policy) for the rules on what may merge during code-freeze and the absolute freeze that follows.
