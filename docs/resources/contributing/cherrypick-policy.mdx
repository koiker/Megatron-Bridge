...
[Release Process](/resources/contributing/release-process); read that document first for the
...
- [Release Process](/resources/contributing/release-process) — full release cadence, RC schedule, and golden-values policy.
- [Releases overview](/about/release-notes) — index of all release-related documentation.
