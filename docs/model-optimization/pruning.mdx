...
Knowledge Distillation is required to recover the performance of the pruned model. See the [Knowledge Distillation](/model-optimization/distillation) guide for more details.
