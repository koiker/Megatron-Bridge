...
This guide explains how to add support for a new 🤗 Hugging Face model (or family) to Megatron Bridge so to convert between HF to and from Megatron-Core formats and participate in training recipes.
...
- Read first:
  - [Bridge user guide](/get-started/quickstart/hugging-face-conversion)
...
- Background: see [Bridge technical details](/about/architecture)
...
- User guide: [Hugging Face conversion quickstart](/get-started/quickstart/hugging-face-conversion)
- Technical deep-dive: [Architecture](/about/architecture)
