...
- For API-centric usage, see the guide: [Bridge with 🤗 Hugging Face](/get-started/quickstart/hugging-face-conversion)
...
- AutoBridge: Detects HF architecture, constructs the appropriate bridge, exposes high-level convert/save APIs. See [bridge.models.conversion.auto bridge](/reference/api).
...
<Note>
For the latest implementation, see [qwen3_bridge.py](https://github.com/NVIDIA-NeMo/Megatron-Bridge/blob/main/src/megatron/bridge/models/qwen/qwen3_bridge.py).
</Note>
